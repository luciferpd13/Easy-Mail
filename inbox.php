<h1 align="center" class="display-4">Inbox</h1>
<?php
include_once('db.php');
...
while(list($mid,$rid,$sid,$snid,$s,$m,$aa,$d,$sss)=mysqli_fetch_array($dd))
{
   ...
   // window.location = 'mail.php?coninb=".$mid."';
    post('mail.php', {coninb: '".$mid."'});
});
  ...
  //  window.location = 'mail.php?coninb=".$mid."';
   post('mail.php', {coninb: '".$mid."'});
	...
	$('#del".$l."').click(function() {
		post('delete_msg.php', {name: '".$mid."'});
	//window.location = 'delete_msg.php?ch%5B%5D=".$mid."&delete=Delete';
	});
